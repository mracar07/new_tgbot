...
def import_data(bot: Bot, update):
    ...
    if msg.reply_to_message and msg.reply_to_message.document:
        try:
            ...
            msg.reply_text("İçe aktarmadan önce dosyayı indirip yeniden yüklemeyi deneyin - dosya şüpheli "
                           "gözüküyor!")
            return
        ...
        try:
            ...
            msg.reply_text("Dosya içeri"
                           " aktarılırken sorun oluştu. "
                           "Sahibim ile iletişime geçerek kontrol edilmesini "
                           "sağlayabilirsin! Teşekkürler! :)")
            LOGGER.exception("Import for chatid %s with name %s failed.", str(chat.id), str(chat.title))
            return

        # TODO: some of that link logic
        # NOTE: consider default permissions stuff?
        msg.reply_text("Yedek başarıyla yüklendi. Hoşgeldin! :D")
